<template>
  <div class="error" v-title :data-title="403">
    <div id="flex-container" :style="{height: screenHeight+'px'}">
      <div class="main-w3layouts">
        ...
        <div class="main-agile">
          <h2>ERROR 403</h2>
          <p></p>
          <div class="botton-w3ls"><a @click="jump" style="text-decoration: none">返回首页</a></div>
        </div>
...
<style lang="scss" scoped>
  .error {
    width: 100%;
    height: 100%;
    background: url("../../assets/bg2.jpg") no-repeat center fixed;
